...
## Approach
1. Read the spec and [AGENTS.md](../../AGENTS.md)'s Architecture/Folder Structure sections.
...
5. Hand off to the Developer agent with the plan.

## Output Format
A markdown plan (inline in chat, or saved to `docs/plans/<feature-slug>.md` for larger work) listing: files to touch, new symbols/interfaces, DI registration changes, and an ordered task list a developer can follow directly.
